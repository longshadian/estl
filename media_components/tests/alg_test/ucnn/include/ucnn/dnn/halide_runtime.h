#ifndef UCNN_HALIDE_HALIDERUNTIME_H
#define UCNN_HALIDE_HALIDERUNTIME_H
...
struct halide_type_t
{
    ...
    HALIDE_ALWAYS_INLINE bool operator!=(const halide_type_t &other) const { return !(*this == other); }
...
typedef struct halide_dimension_t
{
    ...
    {
        return (min == other.min) && (extent == other.extent) && (stride == other.stride) && (flags == other.flags);
    }

    HALIDE_ALWAYS_INLINE bool operator!=(const halide_dimension_t &other) const { return !(*this == other); }
#endif
} halide_dimension_t;
...
#endif  // UCNN_HALIDE_HALIDERUNTIME_H
