...
public:
	...
	const CHART* GetNamedName(int idx) const;
	void Clear();
...
template <class CHART> int CBuilderT <CHART> :: GetNamedCount() const
{
	return m_namedlist.GetSize();
}
template <class CHART> const CHART* CBuilderT <CHART> :: GetNamedName(int idx) const
{
	return ((CBracketElx *)m_namedlist[idx]->m_elxlist[0])->m_szNamed.GetBuffer();
}
...
public:
	...
	const CHART* GetNamedGroupName(int idx) const;
public:
...
template <class CHART> inline int CRegexpT <CHART> :: GetNamedGroupCount() const
{
	return m_builder.GetNamedCount();
}

template <class CHART> inline const CHART* CRegexpT <CHART> ::GetNamedGroupName(int idx) const
{
	return m_builder.GetNamedName(idx);
}
