...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "hellostreamingworld.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
HelloRequest::HelloRequest()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_hellostreamingworld_2eproto::InitDefaultsHelloRequest();
  }
  SharedCtor();
...
HelloReply::HelloReply()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_hellostreamingworld_2eproto::InitDefaultsHelloReply();
  }
  SharedCtor();
